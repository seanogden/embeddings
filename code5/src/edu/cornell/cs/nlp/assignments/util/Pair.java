...
public class Pair<F, S> implements Serializable {
	private static final long	serialVersionUID	= -4729404972259174719L;
	F							first;
	S							second;
	...
	public static class LexicographicPairComparator<F, S>
		...
		public int compare(Pair<F, S> pair1, Pair<F, S> pair2) {
			final int firstCompare = firstComparator.compare(pair1.getFirst(),
					pair2.getFirst());
			if (firstCompare != 0) {
				return firstCompare;
			}
